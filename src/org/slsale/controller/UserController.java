...
public class UserController extends BaseController{
	...
	@RequestMapping("/shopping/updateUserInfo.html")
	@ResponseBody
	public Object updateUserInfo(HttpSession session,
		...
		targetUser.setId(sessionUser.getId());
		targetUser.setExpressType(expressType);
		targetUser.setUserAddress(userAddress);
		targetUser.setPostCode(postCode);
		try {
			userService.modifyUser(targetUser);
			result = "success";
		} catch (Exception e) {
			e.printStackTrace();
			result = "fail";
