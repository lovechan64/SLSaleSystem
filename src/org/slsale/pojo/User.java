...
public class User extends Base{
	...
	private String code;  //安置编号
	private String totalCode;//完整编号  
	private Integer depth;  //安置层数
	private String isLeaf;  //是否为叶子
	private Integer parentId;  //上线用户
    private String activeStatus;//激活状态 0待激活1已激活
    private Date activeTime;  //激活时间
    private int referNum;  //推荐人数
