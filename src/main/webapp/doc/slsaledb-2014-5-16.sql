...
CREATE TABLE `au_user` (
  ...
  `activeStatus` varchar(2) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '激活状态',
...
insert  into `au_user`(`id`,`loginCode`,`password`,`password2`,`userName`,`sex`,`birthday`,`cardType`,`cardTypeName`,`idCard`,`country`,`mobile`,`email`,`userAddress`,`postCode`,`createTime`,`referId`,`referCode`,`roleId`,`roleName`,`userType`,`userTypeName`,`isStart`,`lastUpdateTime`,`lastLoginTime`,`bankAccount`,`bankName`,`accountHolder`,`idCardPicPath`,`bankPicPath`,`expressType`,`activeStatus`,`activeTime`) values (2,'a','1','123456','系统管理员','女','2000-11-25','1','身份证','123456','中国','13522614019','123@hanlu.com','北京市成府路207号北大青鸟楼二层111','121212','2014-03-03 00:00:00',1,'admin',1,'管理员','','',1,'2014-04-09 16:27:54','2014-05-14 19:07:01','3423423432432','中国银行','张果','/statics/uploadfiles/1396950060999_IDcard.jpg','/statics/uploadfiles/1396950267285_bank.jpg',NULL,'1',NULL),(73,'JBIT','123456','123456','北大青鸟','','2011-04-10','1','身份证','123456','中国','123456','','','','2014-04-10 00:00:00',2,'admin',2,'会员','1','注册会员',1,'2014-04-10 14:41:14','2014-04-10 15:15:26','123456','北京银行','北大青鸟','/statics/uploadfiles/1397098771656_IDcard.jpg','/statics/uploadfiles/1397112341821_bank.jpg',NULL,'0',NULL),(76,'aa','111111','111111','aa','',NULL,'1','身份证','111111','中国','1','','','','2014-05-06 14:21:51',2,'a',2,'会员','1','注册会员',1,'2014-05-06 14:21:51',NULL,'11','aa','aa','','',NULL,'0',NULL);
...
CREATE TABLE `order_info` (
  ...
  PRIMARY KEY (`orderId`)
) ENGINE=MyISAM AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='用户订购记录表';

/*Data for the table `order_info` */

insert  into `order_info`(`orderId`,`orderTime`,`orderNum`,`pickUserId`,`repeatPV`,`basePV`,`serviceFee`,`shipFre`,`tax`,`country`,`tel`,`mobile`,`email`,`userAddress`,`postCode`,`stat`,`shipType`,`shipNum`,`shipTime`,`receiveTime`,`shipNote`,`buyUserId`) values (15,'2014-05-13 11:19:53','13999511935534',76,NULL,'300.00',NULL,NULL,NULL,'中国',NULL,'1','','2','2',1,'EMS',NULL,NULL,NULL,NULL,2);
...
CREATE TABLE `order_list` (
  ...
  PRIMARY KEY (`listId`)
) ENGINE=MyISAM AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='用户订购商品表';

/*Data for the table `order_list` */

insert  into `order_list`(`listId`,`orderNum`,`goodsType`,`goodsId`,`goodsSN`,`goodsName`,`goodsFormat`,`goodsNum`,`eachPrice`,`sumPrice`,`discount`,`realPrice`,`currency`,`realPV`,`pvRate`) values (14,13999511935534,NULL,20,'001','消费会员专用',NULL,100,NULL,'300.00',NULL,NULL,'RMB',NULL,'1.0000');
...
insert  into `user_account_201405`(`accountId`,`userId`,`accountData`,`stat`,`baseIn`,`baseOut`,`baseBalance`,`repeatIn`,`repeatOut`,`repeatBalance`,`freePV`,`alreadyPV`,`buyPV`) values (1,2,'2014-05-13',6,300.0000,1.0000,1700.0000,NULL,NULL,NULL,NULL,NULL,NULL),(2,76,'2014-05-13',6,1.0000,0.0000,-1.0000,NULL,NULL,NULL,NULL,NULL,NULL);
...
insert  into `user_account_log_201405`(`accountLogId`,`userId`,`actionTime`,`actionDesc`,`actionType`,`baseIn`,`baseOut`,`baseBalance`,`repeatIn`,`repeatOut`,`repeatBalance`) values (13,2,'2014-05-13 11:19:53','报单购货','6','300.0000','0.0000','1700.0000','0.0000','0.0000','0.0000');
...
CREATE TABLE `user_place` (
  ...
  PRIMARY KEY (`placeId`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='用户安置记录表';

/*Data for the table `user_place` */

insert  into `user_place`(`placeId`,`code`,`totalCode`,`depth`,`isLeaf`,`userId`,`parentId`,`bonusUserId`,`buyPV`,`bonusRate`,`bonusPV`,`placeTime`) values (1,'a','a',1,NULL,2,NULL,NULL,'0.0000','0.0000','0.0000','14:39:25');
...
CREATE TABLE `user_refer` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='用户推荐记录表';

/*Data for the table `user_refer` */

insert  into `user_refer`(`id`,`referTime`,`userId`,`userName`,`referUserId`,`referUserName`,`buyPV`,`bonusRate`,`bonusPV`) values (8,'2014-05-13',76,'aa',2,'a','300.00','0.0500','15.00'),(1,'2014-05-13',73,'北大青鸟',2,'a',NULL,NULL,NULL);
