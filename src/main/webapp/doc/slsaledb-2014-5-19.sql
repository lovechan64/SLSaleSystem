...
MySQL - 5.6.10-log : Database - slsaledb
*********************************************************************
*/
SET NAMES utf8 ;
...
CREATE DATABASE IF NOT EXISTS `slsaledb` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ;
...
insert  into `au_user`(`id`,`loginCode`,`password`,`password2`,`userName`,`sex`,`birthday`,`cardType`,`cardTypeName`,`idCard`,`country`,`mobile`,`email`,`userAddress`,`postCode`,`createTime`,`referId`,`referCode`,`roleId`,`roleName`,`userType`,`userTypeName`,`isStart`,`lastUpdateTime`,`lastLoginTime`,`bankAccount`,`bankName`,`accountHolder`,`idCardPicPath`,`bankPicPath`,`expressType`,`code`,`totalCode`,`depth`,`isLeaf`,`parentId`,`activeStatus`,`activeTime`) values (2,'a','1','123456','系统管理员','女','2000-11-25','1','身份证','123456','中国','13522614019','123@hanlu.com','北京市成府路207号北大青鸟楼二层111','121212','2014-03-03 00:00:00',1,'admin',1,'管理员','','',1,'2014-04-09 16:27:54','2014-05-17 22:41:24','3423423432432','中国银行','张果','/statics/uploadfiles/1396950060999_IDcard.jpg','/statics/uploadfiles/1396950267285_bank.jpg',NULL,'a','a',1,'N',NULL,'1',NULL),(73,'JBIT','123456','123456','北大青鸟','','2011-04-10','1','身份证','123456','中国','123456','','','','2014-04-10 00:00:00',2,'a',2,'会员','1','注册会员',1,'2014-04-10 14:41:14','2014-04-10 15:15:26','123456','北京银行','北大青鸟','/statics/uploadfiles/1397098771656_IDcard.jpg','/statics/uploadfiles/1397112341821_bank.jpg',NULL,'0','a0',2,'N',2,'1','21:47:48'),(76,'aa','111111','111111','aa','',NULL,'1','身份证','111111','中国','1','','','','2014-05-06 14:21:51',2,'a',2,'会员','1','注册会员',1,'2014-05-06 14:21:51',NULL,'11','aa','aa','','',NULL,'1','a01',3,'N',73,'1','22:15:54'),(77,'da','111111','111111','大名','',NULL,'1','身份证','111111','中国','1','','','','2014-05-17 19:47:06',2,'a',2,'会员','1','注册会员',1,'2014-05-17 19:47:06',NULL,'1','1','1','','',NULL,'1','a011',4,'Y',76,'1','22:28:53'),(78,'xiao','111111','111111','xiao','',NULL,'1','身份证','111111','中国','11','','','','2014-05-17 22:33:44',2,'a',2,'会员','1','注册会员',1,'2014-05-17 22:33:44',NULL,'11111','111111','1111','','',NULL,NULL,NULL,NULL,NULL,NULL,'0',NULL);
...
insert  into `goods_pack`(`id`,`goodsPackName`,`goodsPackCode`,`typeId`,`typeName`,`totalPrice`,`state`,`note`,`num`,`createdBy`,`createTime`,`lastUpdateTime`) values (20,'消费会员专用','001',1,'报单套餐',300,1,'',100,'admin','2014-04-10 10:59:27','2014-04-10 11:00:59'),(1,'VIP会员专用','002',1,'报单套餐',900,1,NULL,0,NULL,'2014-04-10 10:59:27',NULL),(2,'加盟店专用','003',1,'报单套餐',1500,1,NULL,0,NULL,'2014-04-10 10:59:27',NULL);
...
CREATE TABLE `order_info` (
  ...
  PRIMARY KEY (`orderId`)
) ENGINE=MyISAM AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='用户订购记录表';

/*Data for the table `order_info` */

insert  into `order_info`(`orderId`,`orderTime`,`orderNum`,`type`,`pickUserId`,`repeatPV`,`basePV`,`serviceFee`,`shipFre`,`tax`,`country`,`tel`,`mobile`,`email`,`userAddress`,`postCode`,`stat`,`shipType`,`shipNum`,`shipTime`,`receiveTime`,`shipNote`,`buyUserId`) values (30,'2014-05-17 22:34:12','14003372521432','BD',78,NULL,'300.00',NULL,NULL,NULL,'中国',NULL,'11','','1','1',1,'EMS',NULL,NULL,NULL,NULL,2),(29,'2014-05-17 22:27:27','14003368472254','BD',77,NULL,'300.00',NULL,NULL,NULL,'中国',NULL,'1','','1','1',1,'EMS',NULL,NULL,NULL,NULL,2),(28,'2014-05-17 22:14:34','14003360739951','BD',76,NULL,'300.00',NULL,NULL,NULL,'中国',NULL,'1','','3','1',1,'顺风',NULL,NULL,NULL,NULL,2),(27,'2014-05-17 21:43:11','14003341916781','BD',73,NULL,'300.00',NULL,NULL,NULL,'中国',NULL,'123456','','1','1',1,'EMS',NULL,NULL,NULL,NULL,2);
...
CREATE TABLE `order_list` (
  ...
  `orderNum` bigint(20) DEFAULT NULL COMMENT '订单号',
  ...
  `eachPrice` decimal(12,2) DEFAULT NULL COMMENT '单价',
  `sumPrice` decimal(12,2) DEFAULT NULL COMMENT '总价',
  `discount` decimal(6,4) DEFAULT NULL COMMENT '折扣',
  `realPrice` decimal(12,2) DEFAULT NULL COMMENT '实际价格',
  `currency` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '货币种类',
  `realPV` decimal(12,2) DEFAULT NULL COMMENT '实际PV',
  `pvRate` decimal(6,4) DEFAULT NULL COMMENT 'PV折算率',
  PRIMARY KEY (`listId`)
) ENGINE=MyISAM AUTO_INCREMENT=30 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='用户订购商品表';

/*Data for the table `order_list` */

insert  into `order_list`(`listId`,`orderNum`,`goodsType`,`goodsId`,`goodsSN`,`goodsName`,`goodsFormat`,`goodsNum`,`eachPrice`,`sumPrice`,`discount`,`realPrice`,`currency`,`realPV`,`pvRate`) values (29,14003372521432,NULL,20,'001','消费会员专用',NULL,100,NULL,'300.00',NULL,NULL,'RMB',NULL,'1.0000'),(28,14003368472254,NULL,20,'001','消费会员专用',NULL,100,NULL,'300.00',NULL,NULL,'RMB',NULL,'1.0000'),(27,14003360739951,NULL,20,'001','消费会员专用',NULL,100,NULL,'300.00',NULL,NULL,'RMB',NULL,'1.0000'),(26,14003341916781,NULL,20,'001','消费会员专用',NULL,100,NULL,'300.00',NULL,NULL,'RMB',NULL,'1.0000');
...
insert  into `user_account_201405`(`accountId`,`userId`,`accountData`,`stat`,`baseIn`,`baseOut`,`baseBalance`,`repeatIn`,`repeatOut`,`repeatBalance`,`freePV`,`alreadyPV`,`buyPV`) values (1,2,'2014-05-17',6,300.0000,1.0000,196400.0000,NULL,NULL,NULL,NULL,NULL,NULL),(2,76,'2014-05-13',6,1.0000,0.0000,-1.0000,NULL,NULL,NULL,NULL,NULL,NULL);
...
insert  into `user_account_201406`(`accountId`,`userId`,`accountData`,`stat`,`baseIn`,`baseOut`,`baseBalance`,`repeatIn`,`repeatOut`,`repeatBalance`,`freePV`,`alreadyPV`,`buyPV`) values (1,2,'2014-04-26',1,1.0000,1.0000,44.0000,NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `user_place` (
  ...
  PRIMARY KEY (`placeId`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='用户安置记录表';

/*Data for the table `user_place` */

insert  into `user_place`(`placeId`,`code`,`totalCode`,`depth`,`isLeaf`,`userId`,`parentId`,`bonusUserId`,`buyPV`,`bonusRate`,`bonusPV`,`placeTime`) values (2,NULL,NULL,NULL,NULL,77,NULL,2,'300.0000','0.0050','1.5000','22:29:17'),(3,NULL,NULL,NULL,NULL,77,NULL,73,'300.0000','0.0050','1.5000','22:29:23'),(4,NULL,NULL,NULL,NULL,77,NULL,76,'300.0000','0.0050','1.5000','22:29:26');
...
CREATE TABLE `user_refer` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='用户推荐记录表';
